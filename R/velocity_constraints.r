...
generate_full_velocity_constraint <- function(constraint_object, max_allowable_increasing_tension_speed, max_allowable_decreasing_tension_speed, indices_for_muscles, num_muscles){
	...
	velocity_constraint <- generate_velocity_constraint_matrix(constraint_object=constraint_object, indices_for_muscles=indices_for_muscles, num_tasks=num_tasks, num_pairs=num_pairs, num_muscles=num_muscles)
